...
import freaktemplate.nearbydoctor.chat.ChatActivity;
...
public class DoctorDetail extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("specialities_id", "onCreate: " + specialities_id);
    ...
    private void setLayout() {
        ...
        ((View) findViewById(R.id.btn_message)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Log.e(TAG, "onClick: "+specialities_mail );
                Log.e(TAG, "onClick: "+email );
                Intent i = new Intent(DoctorDetail.this, ChatActivity.class);
                i.putExtra("profile_id", specialities_id);
                i.putExtra("specialities_name", specialities_name);
                i.putExtra("specialities_email", specialities_mail);
                startActivity(i);
            }
        });
...
//                    myDbHelper.close();
    ...
    private void afterMapReady(double latitude, double longitude) {
        ...
        try {
            ...
            specialities_name=Obj_detail.getString("name");
    ...
    public class GetDataAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                specialities_mail=Obj_detail.getString("email");
                Log.e(TAG, "doInBackground: "+Obj_detail.toString() );
                Log.e(TAG, "doInBackground: "+specialities_mail );
